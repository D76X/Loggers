...
namespace LogXtreme.Infrastructure.Test {
    ...
    public class ContractValidatorTest {
        ...
        public void ContractValidator_EqualTo_Throws_ArgumentException_When_Argument_Is_Not_Equal() {
            ...
            string expectedMessage1 = $"{paramName1} should be equal to {target1} instead is {testParameter1}";
            ...
            string expectedMessage2 = $"{paramName2} should be equal to {target2} instead is {testParameter2}";
            ...
            string expectedMessage3 = $"{paramName3} should be equal to {target3} instead is {testParameter3}";
            ...
            string expectedMessage4 = $"{paramName4} should be equal to {target4} instead is {testParameter4}";
            ...
            string expectedMessage5 = $"{paramName5} should be equal to {target5} instead is {testParameter5}";
            ...
            string expectedMessage6 = $"{paramName6} should be equal to {target6} instead is {testParameter6}";
        ...
        public void ContractValidator_GreaterThan_Throws_ArgumentException_When_Argument_Is_Not_GreaterThan() {
            ...
            // arrange - compare strings
            var testParameter1 = "a";
            var target1 = "z";
            var paramName1 = nameof(testParameter1);
            var validator1 = testParameter1.Validate(paramName1);
            Action actionToTest1 = () => validator1.GreaterThan(target1);
            string expectedMessage1 = $"{paramName1} should be greater than {target1} instead is {testParameter1}";
            ...
            // arrange - compare integers
            var testParameter2 = 0;
            var target2 = 1;
            var paramName2 = nameof(testParameter2);
            var validator2 = testParameter2.Validate(paramName2);
            Action actionToTest2 = () => validator2.GreaterThan(target2);
            string expectedMessage2 = $"{paramName2} should be greater than {target2} instead is {testParameter2}";
            ...
            // arrange - compare double
            var testParameter3 = 0.00;
            var target3 = 1.00;
            var paramName3 = nameof(testParameter3);
            var validator3 = testParameter3.Validate(paramName3);
            Action actionToTest3 = () => validator3.GreaterThan(target3);
            string expectedMessage3 = $"{paramName3} should be greater than {target3} instead is {testParameter3}";
            ...
            // arrange - compare decimal
            var testParameter4 = 0.00d;
            var target4 = 1.00d;
            var paramName4 = nameof(testParameter4);
            var validator4 = testParameter4.Validate(paramName4);
            Action actionToTest4 = () => validator4.GreaterThan(target4);
            string expectedMessage4 = $"{paramName4} should be greater than {target4} instead is {testParameter4}";
            ...
            // arrange - IComparable<T>
            var testParameter5 = new GenComparable(0);
            var target5 = new GenComparable(1);
            var paramName5 = nameof(testParameter5);
            var validator5 = testParameter5.Validate(paramName5);
            ...
            // the validator's value to the target it needs to cast both to 
            // IComparable<GenComparable>.
            Action actionToTest5 = () => validator5.GreaterThan<GenComparable>(target5);

            string expectedMessage5 = $"{paramName5} should be greater than {target5} instead is {testParameter5}";
            ...
            // arrange - IComparable non generic interface
            // IComparable is the same as IComparable<object>
            var testParameter6 = new Comparable(0);
            var target6 = new Comparable(1);
            var paramName6 = nameof(testParameter6);
            var validator6 = testParameter6.Validate(paramName6);
            ...
            // needs to cast to. It will simply cast to IComparable to 
            // perform the comparison.
            Action actionToTest6 = () => validator6.GreaterThan(target6);

            string expectedMessage6 = $"{paramName6} should be greater than {target6} instead is {testParameter6}";
        ...
        public void ContractValidator_GreaterThanOrEqual_Throws_ArgumentException_When_Argument_Is_Not_GreaterThanOrEqual() {
            ...
            var paramName1 = nameof(testParameter1);
            var validator1 = testParameter1.Validate(paramName1);
            Action actionToTest1 = () => validator1.GreaterThanOrEqualTo(target1);
            string expectedMessage1 = $"{paramName1} should be greater than or equal to {target1} instead is {testParameter1}";
            ...
            var paramName2 = nameof(testParameter2);
            var validator2 = testParameter2.Validate(paramName2);
            Action actionToTest2 = () => validator2.GreaterThanOrEqualTo(target2);
            string expectedMessage2 = $"{paramName2} should be greater than or equal to {target2} instead is {testParameter2}";
            ...
            var paramName3 = nameof(testParameter3);
            var validator3 = testParameter3.Validate(paramName3);
            Action actionToTest3 = () => validator3.GreaterThanOrEqualTo(target3);
            string expectedMessage3 = $"{paramName3} should be greater than or equal to {target3} instead is {testParameter3}";
            ...
            var paramName4 = nameof(testParameter4);
            var validator4 = testParameter4.Validate(paramName4);
            Action actionToTest4 = () => validator4.GreaterThanOrEqualTo(target4);
            string expectedMessage4 = $"{paramName4} should be greater than or equal to {target4} instead is {testParameter4}";
            ...
            // the validator's value to the target it needs to cast both to 
            // IComparable<GenComparable>.
            Action actionToTest5 = () => validator5.GreaterThanOrEqualTo<GenComparable>(target5);

            string expectedMessage5 = $"{paramName5} should be greater than or equal to {target5} instead is {testParameter5}";
            ...
            // needs to cast to. It will simply cast to IComparable to 
            // perform the comparison.
            Action actionToTest6 = () => validator6.GreaterThanOrEqualTo(target6);

            string expectedMessage6 = $"{paramName6} should be greater than or equal to {target6} instead is {testParameter6}";
        ...
        public void ContractValidator_SmallerThan_Throws_ArgumentException_When_Argument_Is_Not_SmallerThan() {
            ...
            // arrange - compare strings
            var testParameter1 = "z";
            var target1 = "a";
            var paramName1 = nameof(testParameter1);
            var validator1 = testParameter1.Validate(paramName1);
            Action actionToTest1 = () => validator1.SmallerThan(target1);
            string expectedMessage1 = $"{paramName1} should be smaller than {target1} instead is {testParameter1}";
            ...
            var paramName2 = nameof(testParameter2);
            var validator2 = testParameter2.Validate(paramName2);
            Action actionToTest2 = () => validator2.SmallerThan(target2);
            string expectedMessage2 = $"{paramName2} should be smaller than {target2} instead is {testParameter2}";
            ...
            var paramName3 = nameof(testParameter3);
            var validator3 = testParameter3.Validate(paramName3);
            Action actionToTest3 = () => validator3.SmallerThan(target3);
            string expectedMessage3 = $"{paramName3} should be smaller than {target3} instead is {testParameter3}";
            ...
            var paramName4 = nameof(testParameter4);
            var validator4 = testParameter4.Validate(paramName4);
            Action actionToTest4 = () => validator4.SmallerThan(target4);
            string expectedMessage4 = $"{paramName4} should be smaller than {target4} instead is {testParameter4}";
            ...
            // the validator's value to the target it needs to cast both to 
            // IComparable<GenComparable>.
            Action actionToTest5 = () => validator5.SmallerThan<GenComparable>(target5);

            string expectedMessage5 = $"{paramName5} should be smaller than {target5} instead is {testParameter5}";
            ...
            // needs to cast to. It will simply cast to IComparable to 
            // perform the comparison.
            Action actionToTest6 = () => validator6.SmallerThan(target6);

            string expectedMessage6 = $"{paramName6} should be smaller than {target6} instead is {testParameter6}";
        ...
        public void ContractValidator_SmallerThanOrEqual_Throws_ArgumentException_When_Argument_Is_Not_SmallerThanOrEqual() {
            ...
            var paramName1 = nameof(testParameter1);
            var validator1 = testParameter1.Validate(paramName1);
            Action actionToTest1 = () => validator1.SmallerThanOrEqualTo(target1);
            string expectedMessage1 = $"{paramName1} should be smaller than or equal to {target1} instead is {testParameter1}";
            ...
            var paramName2 = nameof(testParameter2);
            var validator2 = testParameter2.Validate(paramName2);
            Action actionToTest2 = () => validator2.SmallerThanOrEqualTo(target2);
            string expectedMessage2 = $"{paramName2} should be smaller than or equal to {target2} instead is {testParameter2}";
            ...
            var paramName3 = nameof(testParameter3);
            var validator3 = testParameter3.Validate(paramName3);
            Action actionToTest3 = () => validator3.SmallerThanOrEqualTo(target3);
            string expectedMessage3 = $"{paramName3} should be smaller than or equal to {target3} instead is {testParameter3}";
            ...
            var paramName4 = nameof(testParameter4);
            var validator4 = testParameter4.Validate(paramName4);
            Action actionToTest4 = () => validator4.SmallerThanOrEqualTo(target4);
            string expectedMessage4 = $"{paramName4} should be smaller than or equal to {target4} instead is {testParameter4}";
            ...
            // the validator's value to the target it needs to cast both to 
            // IComparable<GenComparable>.
            Action actionToTest5 = () => validator5.SmallerThanOrEqualTo<GenComparable>(target5);

            string expectedMessage5 = $"{paramName5} should be smaller than or equal to {target5} instead is {testParameter5}";
            ...
            // needs to cast to. It will simply cast to IComparable to 
            // perform the comparison.
            Action actionToTest6 = () => validator6.SmallerThanOrEqualTo(target6);

            string expectedMessage6 = $"{paramName6} should be smaller than or equal to {target6} instead is {testParameter6}";
