...
namespace Demo._06.Starter.Proxy.RouterSocket.DealerSocket {
    ...
    class Program {
        ...
        static void Main(string[] args) {
            ...
            const string proxyExePath = @"..\..\..\Demo.06.NetMQ.Proxy.RouterSocket.DealerSocket\bin\Debug\Demo.06.NetMQ.Proxy.RouterSocket.DealerSocket.exe";
            ...
            // start the proxy 
            StartProcess(proxyExePath, $"{frontendProxyEndPoint} {backendProxyEndPoint}");
            Console.WriteLine($"started proxy from {frontendProxyEndPoint} to {backendProxyEndPoint}");
